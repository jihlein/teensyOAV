...
const char* textMenu[] = 
  {
    ...
    //
    Dummy0, GeneralText5, Random1,                                                   // 118 to 120 Spare, Sync RC, High
    //
    ...
    //
    RCMenuItem1,   RCMenuItem0,  RCMenuItem2,                                        // 146 to 157 RC menu
    TransitionOut, TransitionIn, Transition_P1, Transition_P1n,
    Transition_P2, RCMenuItem30, RCMenuItem300, Dummy0, Dummy0,
    //
    MixerMenuItem0, GeneralText100, AutoMenuItem2,                                  // 158 to 169 General
    GeneralText2,   BattMenuItem2,  GeneralText10, 
    GeneralText6,   GeneralText16,  GeneralText7, 
    GeneralText20,  GeneralText21,  Dummy0,
    //
    ...
    Dummy0, 
    //
    Reference_0, Reference_1, Reference_2, Dummy0,                                  // 320 Orientation reference (No, Earth, Vert AP)
    ...
    //
    RXMode0, RXMode1, RXMode2, Dummy0,                                              // 396 to 402 RX mode
    ...
    // THROTTLE, CURVE A, CURVE B, COLLECTIVE, AILERON, ELEVATOR, RUDDER, GEAR, AUX1, AUX2,
    // AUX3, ROLLGYRO, PITCHGYO, YAWGYRO, ROLLSMOOTH, PITCHSMOOTH, ROLLACC, PITCHACC, NONE
    ...
    // THROTTLE, CURVE A, CURVE B, COLLECTIVE, AILERON, ELEVATOR, RUDDER, GEAR, AUX1, AUX2,
    // AUX3, ROLLGYRO, PITCHGYO, YAWGYRO, YAWSMOOTH, PITCHSMOOTH, YAWACC, PITCHACC, NONE
